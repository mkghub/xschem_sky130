...
C {devices/code_shown.sym} 0 -670 0 0 {name=Xyce
only_toplevel=true
value="
vg G1v8 0 0
vs s 0 0
...
.print dc format=raw I(vd1) I(vd2) I(vd3) I(vd5)
" }
...
"}
C {sky130_fd_pr/nfet_03v3_nvt.sym} 1170 -140 0 0 {name=M8
l=0.5u
w=1u
nf=1 mult=1
model=nfet_03v3_nvt
...
C {sky130_fd_pr/nfet_01v8_lvt.sym} 670 -140 0 0 {name=M3
l=0.15u
w=2u
nf=1 mult=1
model=nfet_01v8_lvt
