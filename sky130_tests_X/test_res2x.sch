...
C {devices/code_shown.sym} 60 -770 0 0 {name=Xyce
only_toplevel=true
value="
vp P 0 1.8
vm M 0 0
vb B 0 0
.dc temp -40 140 1
.PRINT DC format=raw 'vp/I(vr1)' 'vp/I(vr2)' 'vp/I(vr3)' 'vp/I(vr5)' 'vp/I(vr6)' 'vp/I(vr7)' 'vp/I(vr8)' 'vp/I(vr9)' 'vp/I(vr10)' 'vp/I(vr11)' 'vp/I(vr12)'
" }
