...
C {devices/code_shown.sym} 20 -890 0 0 {name=Xyce
only_toplevel=true
value="
vg 0 G1v8 0
vs s 0 0
...
.print dc format=raw I(vd1) I(vd2) I(vd3) I(vd4)
" }
...
l=0.35u
w=1u
ad="tcleval([sky130_fet_ad_cb @w ])"
pd="tcleval([sky130_fet_pd_cb @w ])"
as="tcleval([sky130_fet_ad_cb @w ])" 
ps="tcleval([sky130_fet_pd_cb @w ])"
nrd="tcleval([sky130_fet_nrd_cb @w ])" 
nrs="tcleval([sky130_fet_nrd_cb @w ])"
sa=0 sb=0 sd=0
nf=1 mult=1
model=pfet_01v8_lvt
spiceprefix=X
